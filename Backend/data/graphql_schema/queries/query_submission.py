...
class QuerySubmission(object):
    ...
    get_submissions_by_ids = graphene.List(SubmissionType, ids=graphene.List(of_type=graphene.Int))
    ...
    def resolve_get_submissions_by_ids(self, info, **kwargs):
        result = models.models.Q(pk=None)
        for pk in kwargs['ids']:
            result = result | models.models.Q(pk=pk)
